...
# Function to create a simulated attack scenario in a text file
function Create-SimulatedAttackScenario {
    param(
        [string] $filePath = "C:\\Temp\\SimulatedAttackScenario.txt"
    )

    Write-Host "Creating a text file with a simulated attack scenario at $filePath..."

    # Define a simulated attack scenario
    $simulatedAttackContent = @"
...
"@
    ...
    try {
        $simulatedAttackContent | Out-File -FilePath $filePath -Encoding ASCII
        Write-Host "Simulated attack scenario created." -ForegroundColor Green
    } catch {
        Write-Host "Error creating simulated attack scenario: $($_.Exception.Message)" -ForegroundColor Red
    }
}
...
function Simulate-PhishingEmail {
    param(
        [string] $targetEmail = "example@example.com",
        [string] $fakeAttachment = "C:\\Temp\\FakeAttachment.exe"
    )
...
function CheckSysmonLogs {
    ...
    $filePath = "C:\\Temp\\SimulatedAttackScenario.txt"  # Example file to filter by
...
Create-SimulatedAttackScenario -filePath "C:\\Temp\\SimulatedAttackScenario.txt"  # Create a text file with a simulated attack scenario
Simulate-PhishingEmail -targetEmail "example@example.com" -fakeAttachment "C:\\Temp\\FakeAttachment.exe"  # Simulate a phishing email
